    ...
    <footer class="bg-white mt-24">
      <div class="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <Link to="https://flowbite.com/" class="flex items-center">
              ...
              <span class="self-center text-2xl font-semibold whitespace-nowrap">Lazos</span>
            </Link>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase">Seguinos</h2>
              <ul class="text-gray-500 font-medium">
                <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center">© 2023 <Link to="/" class="hover:underline">Flowbite™</Link>. All Rights Reserved.
          </span>
