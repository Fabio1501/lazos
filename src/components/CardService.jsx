...
const CardService = ({icon, title, text, link}) => {
    return (
        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow flex flex-col items-start">
            ...
            <p className="mb-3 font-normal text-gray-500 text-start">{text}</p>
            <Link to={link} className="inline-flex font-medium items-center text-blue-600 hover:underline">
                Ver más
